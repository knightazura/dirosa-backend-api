module.exports = function (app) {
    const teachers = [
        ...
        // Ust. Hermawan
        {
            ...
            "address": {
                "street_name": "Masjid Baitul Mukhlisiin, Vila Cinere Mas. Jl. Matahari L2 , Cipayung, Ciputat timur, Tangsel",
                "province": {
                    "id": 31,
                    "name": "DKI Jakarta"
                },
        ...
        // Ust. Alir
        {
            ...
            "address": {
                "street_name": "Perum Muslim Orchid Green Park Blok F No 8, Pasir Putih, Sawangan",
                "province": {
                    "id": 32,
                    "name": "Jawa Barat"
                },
        ...
        // Ust. Arofah
        {
            ...
            "address": {
                "street_name": "Jl. Komjen Yasin 2 E Komplek Restoran Pondok Laras, Kelapa Dua",
                "province": {
                    "id": 32,
                    "name": "Jawa Barat"
                },
    ...
    app.use("/manual/register-teachers")
}